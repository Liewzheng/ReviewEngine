...
export default {
  ...
  dashboard: {
    ...
    health: {
      ...
      storage: 'Storage',
      database: 'Database',
      storageWritable: 'Write test passed',
      storageHint: 'Database writes are failing — run reng doctor --fix inside the container to repair the storage.',
  ...
  config: {
    ...
    providers: {
      ...
      disableThinkingHint:
        'Skip the provider’s reasoning phase. A reasoning model otherwise spends its whole output budget on thinking and returns an empty answer.',
    ...
    providerCards: {
      ...
      reordered: 'Provider order saved',
      ...
      deletePrimaryRequiresSelection:
        '"{name}" is the chain head — the first enabled card. Drag another provider to the front first, then delete this one.',
    ...
    gitPlatforms: {
      ...
      testOkUrl: 'Connected to {url} — GitLab {version}',
      testFailed: 'Connection failed — {error}',
      testFailedUrl: 'Connection failed — {url}: {error}',
