...
export default {
  ...
  dashboard: {
    ...
    health: {
      ...
      storageWritable: "Test d'écriture réussi",
      storageHint: 'Les écritures en base échouent — exécutez reng doctor --fix dans le conteneur pour réparer le stockage.',
  ...
  config: {
    ...
    providers: {
      ...
      retryAttempts: 'Nombre de nouvelles tentatives',
      disableThinking: 'Désactiver la réflexion',
      disableThinkingHint:
        'Ignore la phase de raisonnement. Sinon, un modèle de raisonnement consomme tout son budget de sortie en réflexion et renvoie une réponse vide.',
    ...
    providerCards: {
      ...
      disabled: '« {name} » est maintenant désactivé',
      reordered: 'Ordre des fournisseurs enregistré',
      ...
      deletePrimaryRequiresSelection:
        '« {name} » est la tête de chaîne — la première carte active. Faites d’abord glisser un autre fournisseur en tête, puis supprimez celui-ci.',
    ...
    gitPlatforms: {
      ...
      testOkUrl: 'Connexion réussie — {url} — GitLab {version}',
      testFailed: 'Échec de la connexion — {error}',
      testFailedUrl: 'Échec de la connexion — {url}: {error}',
    ...
    rules: {
      ...
      maxDurationUnlimited: '0 = illimité',
