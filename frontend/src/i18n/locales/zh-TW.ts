...
export default {
  ...
  history: {
    ...
    drawer: {
      ...
      rawResponse: '原始回應',
      unverified: '未驗證',
      unverifiedTooltip: '所有專家均未發現問題或覆蓋率不足——該得分不是經過驗證的品質訊號。',
    },
    riskLevel: {
      healthy: '健康',
      low: '低',
  ...
  config: {
    ...
    gitlab: {
      ...
      apiTokenPlaceholder: 'glpat-...（*** 保留原值；留空則清除）',
      ...
      defaultProjectHelp: '包含命名空間的完整專案路徑，例如 my-group/my-project。',
      mrLabel: '合併請求標籤',
      autoReview: '已啟用自動審查',
    },
    llm: {
    ...
    providerCards: {
      ...
      addTitle: '新增供應商',
      editTitle: '編輯供應商',
      keepKeyPlaceholder: '留空則保留已儲存的金鑰',
      advanced: '進階設定',
      deleteTitle: '刪除供應商',
      ...
      saved: '供應商已儲存',
      saveFailed: '儲存供應商失敗',
      duplicateProvider: '此供應商已設定',
      providerRequired: '請選擇供應商類型',
      apiKeyRequired: '請填寫 API 金鑰',
      testUnavailable: '此供應商未在伺服器端啟用',
    },
    gitPlatforms: {
      title: 'Git 平台',
      ...
      webhookSigningSecret: 'Webhook 簽章金鑰',
      keepSecretPlaceholder: '留空則保留已儲存的金鑰',
      webhookHelp: 'Webhook 驗簽金鑰，可選。',
      test: '測試',
      testOk: '連線成功 — GitLab {version}',
      testFailed: '連線失敗 — {error}',
      addDialogTitle: '新增 Git 平台',
      editDialogTitle: '編輯 Git 平台',
      nameRequired: '請輸入名稱',
